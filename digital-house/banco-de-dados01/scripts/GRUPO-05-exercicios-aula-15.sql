...
SELECT COUNT(FaturaID) as qtd_faturas, faturas.ClienteID, clientes.Empresa FROM faturas
...
SELECT ProdutoID, ProdutoNome, QuantidadePorUnidade FROM produtos
...
-- teclado		1				85			85
-- total da fatura: 100
SELECT FaturaId as fatura, ProdutoID as produto, Quantidade as quantidade, PrecoUnitario as valor, (PrecoUnitario * Quantidade) * ((Desconto + 1) - (Desconto * 2)) AS total FROM detalhefatura;
